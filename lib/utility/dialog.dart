...
//      title: "Error", subtitle: message, style: SweetAlertStyle.error);
//}
//
//Future<void> showSuccessMessage(BuildContext context, String message) {
//  SweetAlert.show(context,
//      title: "Success", subtitle: message, style: SweetAlertStyle.success);
//}
...
Future showSuccessMessage(BuildContext context, String message) {
  AwesomeDialog(
    context: context,
